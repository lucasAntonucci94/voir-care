  ...
  <div class="relative">
    ...
    <form @submit.prevent="createPost" class="space-y-6">
      ...
      <div v-if="currentStep === 1">
        <!-- Título -->
        <div class="mb-4">
          <label for="post-title" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-200">Título</label>
          <input 
            id="post-title"
            name="title"
        ...
        <!-- Descripción -->
        <div class="mb-4">
          <label for="post-description" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-200">Descripción</label>
          <textarea 
            id="post-description"
            name="description"
      ...
      <div v-if="currentStep === 3">
        ...
        <div v-if="newPost?.media.imageBase64" class="mt-2">
          <img 
            ...
            :aria-describedby="newPost.media.imageBase64 ? 'media-preview' : null"
            :aria-invalid="!newPost.media.imageBase64"
            :aria-required="true"
            @contextmenu.prevent
            @dragover.prevent
            @drop.prevent
