<template>
    <div class="container mx-auto p-4 flex flex-col md:flex-row h-screen bg-gray-50">
      <!-- Lista de chats (lado izquierdo) -->
      <div class="w-full md:w-1/3 bg-white rounded-lg shadow-md p-4 mb-4 md:mb-0 md:mr-4 overflow-y-auto" style="max-height: 80vh;">
        ...
        <div v-else-if="privateChatsStore.chats.value.length === 0" class="text-center text-gray-500">
        ...
        <div v-else class="space-y-2">
          <div
            ...
            :key="chat.idDoc"
            class="flex items-center p-2 rounded-lg transition-colors duration-200 hover:bg-gray-100 cursor-pointer"
